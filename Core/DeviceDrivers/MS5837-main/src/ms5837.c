 ...
 *
 * modified by tom wolcott to avoid callbacks
 */
...
static float ms5837_depth_mm( ms5837_t *sensor )
{
    return 10.197162129779 * sensor->measurements[SENSOR_PRESSURE] / 100.0f;
}
