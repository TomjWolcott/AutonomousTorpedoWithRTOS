...
class ICM42688 {
 ...
 protected:
	...
	static const uint8_t FIFO_EN      = 0x5F;
	static const uint8_t FIFO_TEMP_EN = 0x04;
	static const uint8_t FIFO_GYRO    = 0x02;
	static const uint8_t FIFO_ACCEL   = 0x01;
	// const uint8_t FIFO_COUNT = 0x2E;
	// const uint8_t FIFO_DATA = 0x30;

	// BANK 1
	// const uint8_t GYRO_CONFIG_STATIC2 = 0x0B;
	static const uint8_t GYRO_NF_ENABLE   = 0x00;
	static const uint8_t GYRO_NF_DISABLE  = 0x01;
	static const uint8_t GYRO_AAF_ENABLE  = 0x00;
	static const uint8_t GYRO_AAF_DISABLE = 0x02;

	// BANK 2
	// const uint8_t ACCEL_CONFIG_STATIC2 = 0x03;
	static const uint8_t ACCEL_AAF_ENABLE  = 0x00;
	static const uint8_t ACCEL_AAF_DISABLE = 0x01;
